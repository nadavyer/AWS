...
public class EC2 {
    ...
    private static List<Instance> activeInstances = new LinkedList<>();
...
//                    .setKeyName("ssh_login");
            ...
            tags.add(t);
            List<TagSpecification> specifications = new LinkedList<>();
...
//            System.out.println("**********");
    ...
    private static boolean closeMachinesByTag(String tag){
        ...
        List <String> machinesIdByTag = new LinkedList<>();
